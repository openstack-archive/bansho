...
angular.module('bansho.host', ['bansho.surveil',
    ...
    .controller('HostCtrl', ['$scope', 'hostConfig', 'surveilLive', function ($scope, hostConfig, surveilLive) {
        var objectType = 'host',
            objectIdentifier = {};

        objectIdentifier.host_name = hostConfig.hostName;
        surveilLive.getHost(objectType, objectIdentifier).then(function (data) {
            $scope.host = data;
            $scope.data = data;

            surveilLive.getServicesByHost($scope.hostName).success(function (data) {
                var i,
                    service;
    ...
    .directive('banshoHost', ['$http', '$compile', 'surveilLive', 'hostConfig',
        function ($http, $compile, surveilLive, hostConfig) {
            return {
                restrict: 'E',
                compile: function () {
