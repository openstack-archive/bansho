    ...
    .directive('banshoTable', ['datasource', 'tableGlobalConfig',
        function (datasource, tableGlobalConfig) {
            return {
                ...
                controller: ['$scope', '$interval', 'headerFollow', 'surveilStatus', 'datasource', 'tableGlobalConfig', 'promisesManager',
                    function ($scope, $interval, headerFollow, surveilStatus, datasource, tableGlobalConfig,
                              promisesManager) {
                        var conf = {};
                        ...
                        var conf = datasource.getConfig($scope.tableId),
