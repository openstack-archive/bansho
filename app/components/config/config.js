...
angular.module('bansho.config', [])
    ...
    .service('configManager', ['$http', '$q', 'componentsConfig', 'surveilApiEndpoint',
        function ($http, $q, componentsConfig, surveilApiEndpoint) {
            var config = {},
                developmentConfig = {};
            ...
            this.loadDevelopmentConfig = function() {
                ...
                $http.get('components/config/developmentConfig.json')
                    .success(function (config) {
                        ...
                        console.log('config ')
                        console.log(config)
                        surveilApiEndpoint = config.surveilApi;
                        promise.resolve();
                    })
                    .error(function() {
                        promise.reject();
