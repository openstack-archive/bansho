                            ...
                            executeQuery('surveil/v2/status/services/', 'POST', serviceQuery)
                                .success(function (services) {
                                    ...
                                    angular.forEach(hosts, function (host) {
                                        ...
                                        hostsDict[host.host_host_name] = host;
                                    });
                                    ...
                                    angular.forEach(services, function (service) {
                                        ...
                                        angular.forEach(service, function (value, attr) {
                                            data['service_' + attr] = value;
                                        });

                                        angular.forEach(hostsDict[data.service_host_name], function (value, attr) {
                                            data[attr] = value;
                                        });

                                        if (hostsDict[data.service_host_name]) {
                                            response.push(data);
                                        }
                                    });
